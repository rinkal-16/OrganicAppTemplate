...
export class ResetPswdService {
  ...
  public get_resetpswd(): Observable<any> {
    return this.http.get<any>("https://fde0c9e1b0ce.ngrok.io/lrf/reset_password/RGSMMH/");    
  }
  ...
  public post_resetpswd(formData: any): Observable<any> {
    ...
    return this.http.post<ResetPswd>("https://fde0c9e1b0ce.ngrok.io/lrf/reset_password/RGSMMH/", form 
    // {
