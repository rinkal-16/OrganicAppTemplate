...
export class ResetPswdService {
  ...
  public get_resetpswd(): Observable<any> {
    return this.http.get<any>("https://6595ebe5cfce.ngrok.io/lrf/reset_password/RGSMMH/");    
  }
  ...
  public post_resetpswd(formData: any): Observable<any> {
    ...
    return this.http.post<ResetPswd>("https://6595ebe5cfce.ngrok.io/lrf/reset_password/RGSMMH/", form);  
  }
